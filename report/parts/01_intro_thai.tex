...
\subsection{Nghịch lý của các mô hình Deep Learning hiện đại}
Một động lực quan trọng khác để thực hiện đề tài này xuất phát từ sự thay đổi quan điểm trong cộng đồng nghiên cứu. Trước kỷ nguyên Deep Learning, giả thuyết phổ biến cho rằng người già dễ nhận diện hơn người trẻ do các đặc trưng khuôn mặt đã ổn định. Tuy nhiên, với sự ra đời của các mô hình Deep CNN hiện đại (như ArcFace, VGG), các nghiên cứu thực nghiệm lại chỉ ra một nghịch lý: độ chính xác nhận diện ở nhóm người già thấp hơn so với người trẻ.

Nguyên nhân chính được xác định là do sự phân bố của dữ liệu giả mạo (impostor distribution) ở người già có xu hướng chồng lấn nhiều hơn, khiến mô hình dễ nhầm lẫn giữa hai người già khác nhau. Việc kiểm chứng và phân tích nghịch lý này chính là lý do cốt lõi để thực hiện đề tài, nhằm đánh giá xem các mô hình hiện đại thực sự "hiểu" khuôn mặt lão hóa như thế nào.
